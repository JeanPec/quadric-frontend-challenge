...
export const ConfigProvider =({ children } : {children?: ReactNode | undefined} ) => {
    const isMobile = navigator.userAgent.indexOf("Mobi") > -1 || Math.min(window.innerWidth, window.innerHeight) < 768;
